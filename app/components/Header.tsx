...
{/* top header */}
    <div className='hidden md:flex justify-between h-[38px] bg-[#000000] '>
      <div className='ml-[544px] text-[#FFFFFF] md:ml-[544px]'>Sign up and get 20% off to your first order.<Button variant={"apnaStyle"} className='underline'>Sign Up Now</Button></div>
...
<Link href="./sign-up"><Image src={"/images/email icon.svg"}alt="icon"width={24}height={24}/></Link>
